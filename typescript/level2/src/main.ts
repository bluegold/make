...
import { expandVariables, normalizeProgram, parseTaskFile, resolveDependencies, runTaskOrder } from '../../core';
...
function main() {
    ...
    runTaskOrder(order, program.tasks, command => expandVariables(command, program.variables));
}
